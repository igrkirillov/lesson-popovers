...
;// CONCATENATED MODULE: ./src/js/placements.js
var placements = {
  top: "top",
  bottom: "bottom",
  left: "left",
...
;// CONCATENATED MODULE: ./src/js/PopoversWidget.js
...
var PopoversWidget = /*#__PURE__*/function () {
  function PopoversWidget(ownerElement) {
    _classCallCheck(this, PopoversWidget);
  ...
  return _createClass(PopoversWidget, [{
    key: "createElement",
    value: function createElement(ownerElement) {
      var titleStr = ownerElement.dataset["title"];
      var contentStr = ownerElement.dataset["content"];
      var innerMarkup = "<div class=\"popovers-title\">\n          ".concat(titleStr, "\n        </div>\n        <div class=\"popovers-content\">\n            <span>\n                ").concat(contentStr, "\n            </span>          \n        </div>");
      var popoversElement = document.createElement("div");
    ...
    key: "addOpenCloseActionsListener",
    value: function addOpenCloseActionsListener(ownerElement) {
      var widget = this;
      ownerElement.addEventListener("click", function () {
        if (widget.isVisible()) {
          widget.close();
        } else {
          widget.open();
    ...
    key: "locatePosition",
    value: function locatePosition(ownerRect) {
